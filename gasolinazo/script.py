...
catGas = 3
catHot = 2
urlPronostico = "http://pronosticodemanda.pemex.com/WS_GP_2/Pemex.Servicios.svc/web/get_Est_Reg?callback=jQuery111004208794787871024_1484250912002&latne={latne}&lonne={lonne}&latsw={latsw}&lonsw={lonsw}&z=5&category={cat}&_=1484250912004".format(latne=latne, lonne=lonne, latsw=latsw, lonsw=lonsw, cat=catGas)
...
def estaciones(path):
    estacion_array = []
    try:
        r = requests.get(urlPronostico)
        json_d = r.content[42:]
        json_d = json_d[:len(json_d)-2]
